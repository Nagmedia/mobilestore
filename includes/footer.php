...
?>
                                ...
                                <li class="footer__address-item"><span>Call us: </span>+91(<?php  echo $row['MobileNumber'];?>)</li>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12 col-12">
                        <div class="footer__copyright-text"> 
                            ...
                            <p style="color:red;font-size: 20px;text-align: center;">2024 &copy; Mobile Store Management System</p>
                        </div>
                    </div>
