...
$todysale+=$todays_sale;
 ...
 ?>
            ...
            <div class="right"> <strong>Rs.<?php echo $todysale;?></strong> <a href="#">Today's Sale</a> </div>
          </li>
          <li>
           <?php
//Yesterday's sale
...
$yesterdaysale+=$yesterdays_sale;
 ...
 ?>
            <div class="left peity_line_neutral"><span><span style="display: none;">10,15,8,14,13,10,10,15</span>
             ...
             <div class="right"> <strong>Rs.<?php echo $yesterdaysale;?></strong> <a href="#">Yesterday's Sale</a> </div>
          </li>
          <li>
            <?php
//Last Sevendays Sale
...
$tseven+=$sevendays_sale;
 ...
 ?>
            ...
            <div class="right"> <strong>Rs.<?php echo $tseven;?></strong> <a href="#">Last Sevenday's Sale</a> </div>
          </li>
          <li>
            <?php
//Total Sale
...
$totalsale+=$total_sale;
 ...
 ?>
            ...
            <div class="right"> <strong>Rs.<?php echo $totalsale;?></strong> <a href="#">Total Sale</a> </div>
          </li>
